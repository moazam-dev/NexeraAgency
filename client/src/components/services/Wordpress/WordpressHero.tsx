...
import bg from "./wordpressHero.jpg"; // Adjust the path as necessary
      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="flex items-center min-h-screen">
          <div className="w-full max-w-2xl lg:max-w-3xl xl:max-w-4xl">
            ...
            >
              Custom themes, powerful plugins, and seamless integrations our <br /> WordPress solutions are tailored to your brand and business goals.
            </motion.p>
