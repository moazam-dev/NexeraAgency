      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="flex items-center min-h-screen">
          <div className="w-full max-w-2xl lg:max-w-3xl xl:max-w-4xl">
            ...
            >
              Elevate Your <br /> <span className="">WordPress Presence.</span>
            </h1>
            ...
            >
              Custom themes, powerful plugins, and seamless integrations—our WordPress solutions are tailored to your brand and business goals.<br />
              Unlock the full potential of WordPress with expert development, robust security, and ongoing support.
            </motion.p>
