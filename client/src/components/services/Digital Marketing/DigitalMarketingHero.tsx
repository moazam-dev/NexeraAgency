      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="flex items-center min-h-screen">
          <div className="w-full max-w-2xl lg:max-w-3xl xl:max-w-4xl">
            ...
            >
              Accelerate Your <br /> <span className="">Digital Growth.</span>
            </h1>
            ...
            >
              We drive results with data-driven strategies, creative campaigns, and targeted digital marketing that connects you with your ideal audience and grows your brand online.
            </motion.p>
