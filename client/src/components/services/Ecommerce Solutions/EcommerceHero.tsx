      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="flex items-center min-h-screen">
          <div className="w-full max-w-2xl lg:max-w-3xl xl:max-w-4xl">
            ...
            >
              Powering Your <br /> <span className="">Online Success.</span>
            </h1>
            ...
            >
              We build seamless, scalable eCommerce solutions that drive sales, enhance customer experience, and help your business thrive in the digital marketplace.
            </motion.p>
