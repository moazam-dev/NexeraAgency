...
export default function App() {
    const features = [
        { icon: <ShieldCheck size={28} className="text-white" />, title: "Strategic Storytelling", description: "We uncover the heart of your business and craft a brand narrative that resonates, inspires, and sets you apart in a crowded world.", delay: 0.1 },
        { icon: <Zap size={28} className="text-white" />, title: "Memorable Visual Identity", description: "From logo to color palette, we design every element to ensure your brand is instantly recognizable and unforgettable.", delay: 0.2 },
        { icon: <Puzzle size={28} className="text-white" />, title: "Unified Brand Experience", description: "We create consistency across every touchpoint—digital, print, and beyond—so your audience always knows and trusts your brand.", delay: 0.3 },
        { icon: <TrendingUp size={28} className="text-white" />, title: "Emotional Connection", description: "We help you build a brand that connects on a deeper level, turning first-time viewers into loyal advocates.", delay: 0.4 },
        { icon: <Paintbrush size={28} className="text-white" />, title: "Distinctive Positioning", description: "Stand out from the competition with a brand identity that highlights your unique strengths and vision.", delay: 0.5 },
        { icon: <Scaling size={28} className="text-white" />, title: "Future-Ready Growth", description: "Our brand strategies are designed to evolve with you, supporting your growth and adapting as your business expands.", delay: 0.6 },
    ];
