      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
            Comprehensive <span className="relative inline-block text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-blue-500">Brand Identity Services</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            From strategy and naming to design, messaging, and packaging, our brand identity services help you build a brand that is authentic, memorable, and consistent across every touchpoint.
          </p>
        </motion.div>
