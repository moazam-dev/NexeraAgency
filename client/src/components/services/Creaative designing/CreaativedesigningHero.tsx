...
import bg from "./creativedesign.jpg";
      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="flex items-center min-h-screen">
          <div className="w-full max-w-2xl lg:max-w-3xl xl:max-w-4xl">
            ...
            >
              Design That <br /> <span className="">Inspires & Engages.</span>
            </h1>
            ...
            >
              We create visually stunning and meaningful designs that capture your brand’s essence, spark curiosity, and leave a lasting impression on your audience.
            </motion.p>
